...
const configuration = require('../sample/sledge_w4_tmp.json');
...
const options = {
    ...
    maxRequests: rps.reduce((a, b) => a + b, 0),
    // maxRequests: 10000,
    //headers: { 'Host': 'autoscale-go-1.default.example.com' },
    //method: 'POST',
    body: readBody("/users/xiaosuGW/sledge-serverless-framework/runtime/tests/40k.jpg",'-p'),
