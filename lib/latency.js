...
class Latency {
	constructor(options, callback) {
		...
		//added by xiaosu for testing
		//this.last_t = process.uptime()*1000;
	}
	...
	start(requestId) {
		...
		//added by xiaosu for testing
		//var t = process.uptime()*1000;
		//var itv = t - this.last_t;
		//this.last_t = t;
		//log.debug('xiaosu:' + itv);
	...
	add(time, errorCode) {
		...
		if (errorCode) {
			...
			//GWU modify
			this.totalSuccessRequests++;
			log.debug('Success value: %s', time);
